#Streamlit is used to create a Web Application really quickly
import os
import json
import traceback
import pandas as pd
...
#Loading json file
with open(r'C:\Users\liza0\generativeaiproject\Response.json', 'r') as file:
    RESPONSE_JSON = json.load(file)

#Creating a title for the app
st.title("MCQ Creator Application with LangChain")

#Creating a form using sst.form
with st.form("user_inputs"):
    #Upload the File
    uploaded_file=st.file_uploader("Upload a PRD or a TXT file")
    ...
    if button and uploaded_file is not None and mcq_count and subject and tone:
        with st.spinner("loading.."):
            try:
                ...
                #Cpunt tokens anf the cost of API call
